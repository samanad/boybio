...
class Chats extends Controller {
    ...
    public function index() {
        ...
        $filters->set_default_order_by($this->user->preferences->chats_default_order_by ?? 'chat_id', $this->user->preferences->default_order_type ?? settings()->main->default_order_type);
