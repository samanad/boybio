...
class AdminSettings extends Controller {
    ...
    public function links() {
        ...
        if(!empty($_POST)) {
            ...
            $_POST['biolinks_themes_is_enabled'] = (int) isset($_POST['biolinks_themes_is_enabled']);
            ...
            $_POST['avatar_size_limit'] = (isset($_POST['avatar_size_limit']) && $_POST['avatar_size_limit'] > get_max_upload()) || (isset($_POST['avatar_size_limit']) && $_POST['avatar_size_limit'] < 0) ? get_max_upload() : (float) ($_POST['avatar_size_limit'] ?? 0);
            $_POST['background_size_limit'] = (isset($_POST['background_size_limit']) && $_POST['background_size_limit'] > get_max_upload()) || (isset($_POST['background_size_limit']) && $_POST['background_size_limit'] < 0) ? get_max_upload() : (float) ($_POST['background_size_limit'] ?? 0);
            $_POST['favicon_size_limit'] = (isset($_POST['favicon_size_limit']) && $_POST['favicon_size_limit'] > get_max_upload()) || (isset($_POST['favicon_size_limit']) && $_POST['favicon_size_limit'] < 0) ? get_max_upload() : (float) ($_POST['favicon_size_limit'] ?? 0);
            $_POST['seo_image_size_limit'] = (isset($_POST['seo_image_size_limit']) && $_POST['seo_image_size_limit'] > get_max_upload()) || (isset($_POST['seo_image_size_limit']) && $_POST['seo_image_size_limit'] < 0) ? get_max_upload() : (float) ($_POST['seo_image_size_limit'] ?? 0);
            $_POST['thumbnail_image_size_limit'] = (isset($_POST['thumbnail_image_size_limit']) && $_POST['thumbnail_image_size_limit'] > get_max_upload()) || (isset($_POST['thumbnail_image_size_limit']) && $_POST['thumbnail_image_size_limit'] < 0) ? get_max_upload() : (float) ($_POST['thumbnail_image_size_limit'] ?? 0);
            $_POST['image_size_limit'] = (isset($_POST['image_size_limit']) && $_POST['image_size_limit'] > get_max_upload()) || (isset($_POST['image_size_limit']) && $_POST['image_size_limit'] < 0) ? get_max_upload() : (float) ($_POST['image_size_limit'] ?? 0);
            $_POST['audio_size_limit'] = (isset($_POST['audio_size_limit']) && $_POST['audio_size_limit'] > get_max_upload()) || (isset($_POST['audio_size_limit']) && $_POST['audio_size_limit'] < 0) ? get_max_upload() : (float) ($_POST['audio_size_limit'] ?? 0);
            $_POST['video_size_limit'] = (isset($_POST['video_size_limit']) && $_POST['video_size_limit'] > get_max_upload()) || (isset($_POST['video_size_limit']) && $_POST['video_size_limit'] < 0) ? get_max_upload() : (float) ($_POST['video_size_limit'] ?? 0);
            $_POST['file_size_limit'] = (isset($_POST['file_size_limit']) && $_POST['file_size_limit'] > get_max_upload()) || (isset($_POST['file_size_limit']) && $_POST['file_size_limit'] < 0) ? get_max_upload() : (float) ($_POST['file_size_limit'] ?? 0);
            $_POST['product_file_size_limit'] = (isset($_POST['product_file_size_limit']) && $_POST['product_file_size_limit'] > get_max_upload()) || (isset($_POST['product_file_size_limit']) && $_POST['product_file_size_limit'] < 0) ? get_max_upload() : (float) ($_POST['product_file_size_limit'] ?? 0);
            $_POST['static_size_limit'] = (isset($_POST['static_size_limit']) && $_POST['static_size_limit'] > get_max_upload()) || (isset($_POST['static_size_limit']) && $_POST['static_size_limit'] < 0) ? get_max_upload() : (float) ($_POST['static_size_limit'] ?? 0);
            $_POST['pwa_icon_size_limit'] = (isset($_POST['pwa_icon_size_limit']) && $_POST['pwa_icon_size_limit'] > get_max_upload()) || (isset($_POST['pwa_icon_size_limit']) && $_POST['pwa_icon_size_limit'] < 0) ? get_max_upload() : (float) ($_POST['pwa_icon_size_limit'] ?? 0);
