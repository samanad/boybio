...
class Spotlight extends Controller {
    ...
    public function index() {
        ...
        if(is_logged_in()) {
            ...
            if(settings()->links->biolinks_is_enabled && !empty(settings()->links->directory_is_enabled) && ((settings()->links->directory_access ?? 'everyone') == 'everyone' || ((settings()->links->directory_access ?? '') == 'users' && is_logged_in()))) {
                $available_pages[] = [
