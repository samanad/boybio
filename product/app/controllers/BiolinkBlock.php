    ...
    public function index() {
        ...
        switch($method) {
            case 'statistics':
                ...
                $type = isset($_GET['type']) && in_array($_GET['type'], ['overview', 'entries', 'referrer_host', 'referrer_path', 'continent_code', 'country', 'city_name', 'os', 'browser', 'device', 'language', 'utm_source', 'utm_medium', 'utm_campaign', 'hour']) ? query_clean($_GET['type']) : 'overview';
