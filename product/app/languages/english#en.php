...
return [
	...
	'global.emails.user_data_collected.subject' => 'New {{BLOCK_TYPE}} submission for \'{{BLOCK_TITLE}}\' - {{WEBSITE_TITLE}}',
	'global.emails.user_data_collected_phone_collector.body' => 'Hello, <strong>{{NAME}}</strong>,<br /><br />You received a new <strong>Phone Collector</strong> submission.<br /><br /><strong>Block:</strong> {{BLOCK_TITLE}}<br /><strong>Link:</strong> {{LINK_URL}}<br /><strong>Name:</strong> {{DATA_NAME}}<br /><strong>Phone:</strong> {{DATA_PHONE}}<br /><br /><a href="{{DATA_LINK}}" class="cta">View submission</a><br /><br />Regards,<br />The {{WEBSITE_TITLE}} team.',
	'global.emails.user_data_collected_email_collector.body' => 'Hello, <strong>{{NAME}}</strong>,<br /><br />You received a new <strong>Email Collector</strong> submission.<br /><br /><strong>Block:</strong> {{BLOCK_TITLE}}<br /><strong>Link:</strong> {{LINK_URL}}<br /><strong>Name:</strong> {{DATA_NAME}}<br /><strong>Email:</strong> {{DATA_EMAIL}}<br /><br /><a href="{{DATA_LINK}}" class="cta">View submission</a><br /><br />Regards,<br />The {{WEBSITE_TITLE}} team.',
	'global.emails.user_data_collected_contact_collector.body' => 'Hello, <strong>{{NAME}}</strong>,<br /><br />You received a new <strong>Contact Form</strong> submission.<br /><br /><strong>Block:</strong> {{BLOCK_TITLE}}<br /><strong>Link:</strong> {{LINK_URL}}<br /><strong>Name:</strong> {{DATA_NAME}}<br /><strong>Email:</strong> {{DATA_EMAIL}}<br /><strong>Phone:</strong> {{DATA_PHONE}}<br /><strong>Message:</strong> {{DATA_MESSAGE}}<br /><br /><a href="{{DATA_LINK}}" class="cta">View submission</a><br /><br />Regards,<br />The {{WEBSITE_TITLE}} team.',
	'global.emails.user_data_collected_appointment_calendar.body' => 'Hello, <strong>{{NAME}}</strong>,<br /><br />You received a new <strong>Appointment Calendar</strong> booking.<br /><br /><strong>Block:</strong> {{BLOCK_TITLE}}<br /><strong>Link:</strong> {{LINK_URL}}<br /><strong>Date:</strong> {{DATA_DATE}}<br /><strong>Time:</strong> {{DATA_TIME}}<br /><strong>Duration:</strong> {{DATA_DURATION}}<br /><strong>Name:</strong> {{DATA_NAME}}<br /><strong>Email:</strong> {{DATA_EMAIL}}<br /><strong>Phone:</strong> {{DATA_PHONE}}<br /><strong>Message:</strong> {{DATA_MESSAGE}}<br /><br /><a href="{{DATA_LINK}}" class="cta">View booking</a><br /><br />Regards,<br />The {{WEBSITE_TITLE}} team.',

    'global.emails.user_guest_payment_donation.subject' => 'New {{TOTAL_AMOUNT}} {{CURRENCY}} donation for \'{{DONATION_TITLE}}\' - {{WEBSITE_TITLE}}',
    'global.emails.user_guest_payment_donation.body' => 'Hello, <strong>{{NAME}}</strong>,<br /><br />You received a new donation from one of your visitors.<br /><br /><strong>Donation:</strong> {{DONATION_TITLE}}<br /><strong>Amount:</strong> {{TOTAL_AMOUNT}} {{CURRENCY}}<br /><strong>Processor:</strong> {{PROCESSOR}}<br /><strong>Name:</strong> {{PAYER_NAME}}<br /><strong>Email:</strong> {{EMAIL}}<br /><strong>Message:</strong> {{MESSAGE}}<br /><br /><a href="{{GUEST_PAYMENT_LINK}}" class="cta">View payment</a><br /><br />Regards,<br />The {{WEBSITE_TITLE}} team.',

    'global.emails.guest_guest_payment_donation.subject' => 'Donation received for \'{{DONATION_TITLE}}\' - {{WEBSITE_TITLE}}',
    'global.emails.guest_guest_payment_donation.body' => 'Hello, <strong>{{NAME}}</strong>,<br /><br />Your donation for <strong>{{DONATION_TITLE}}</strong> was successful. Thank you for your contribution.<br /><br />Regards,<br />The {{WEBSITE_TITLE}} team.',

    'global.emails.user_guest_payment_product.subject' => 'New sale: \'{{PRODUCT_TITLE}}\' for {{TOTAL_AMOUNT}} {{CURRENCY}} - {{WEBSITE_TITLE}}',
    'global.emails.user_guest_payment_product.body' => 'Hello, <strong>{{NAME}}</strong>,<br /><br />You received a new product payment from one of your visitors.<br /><br /><strong>Product:</strong> {{PRODUCT_TITLE}}<br /><strong>Amount:</strong> {{TOTAL_AMOUNT}} {{CURRENCY}}<br /><strong>Processor:</strong> {{PROCESSOR}}<br /><strong>Name:</strong> {{PAYER_NAME}}<br /><strong>Email:</strong> {{EMAIL}}<br /><br /><a href="{{GUEST_PAYMENT_LINK}}" class="cta">View payment</a><br /><br />Regards,<br />The {{WEBSITE_TITLE}} team.',

    'global.emails.guest_guest_payment_product.subject' => 'Your purchase of \'{{PRODUCT_TITLE}}\' - {{WEBSITE_TITLE}}',
    'global.emails.guest_guest_payment_product.body' => 'Hello, <strong>{{NAME}}</strong>,<br /><br />Your purchase of <strong>{{PRODUCT_TITLE}}</strong> was successful. You can download your product using the link below.<br /><br /><strong>Download link:</strong> {{DOWNLOAD_LINK}}<br /><br />Regards,<br />The {{WEBSITE_TITLE}} team.',

    'global.emails.user_guest_payment_service.subject' => 'New service payment: \'{{SERVICE_TITLE}}\' for {{TOTAL_AMOUNT}} {{CURRENCY}} - {{WEBSITE_TITLE}}',
    'global.emails.user_guest_payment_service.body' => 'Hello, <strong>{{NAME}}</strong>,<br /><br />You received a new service payment from one of your visitors.<br /><br /><strong>Service:</strong> {{SERVICE_TITLE}}<br /><strong>Amount:</strong> {{TOTAL_AMOUNT}} {{CURRENCY}}<br /><strong>Processor:</strong> {{PROCESSOR}}<br /><strong>Name:</strong> {{PAYER_NAME}}<br /><strong>Email:</strong> {{EMAIL}}<br /><strong>Message:</strong> {{MESSAGE}}<br /><br /><a href="{{GUEST_PAYMENT_LINK}}" class="cta">View payment</a><br /><br />Regards,<br />The {{WEBSITE_TITLE}} team.',

    'global.emails.guest_guest_payment_service.subject' => 'Payment received for \'{{SERVICE_TITLE}}\' - {{WEBSITE_TITLE}}',
    'global.emails.guest_guest_payment_service.body' => 'Hello, <strong>{{NAME}}</strong>,<br /><br />Your payment for <strong>{{SERVICE_TITLE}}</strong> was successful. The service provider will contact you as soon as possible.<br /><br />Regards,<br />The {{WEBSITE_TITLE}} team.',
    ...
    'global.plan_settings.digital_wallets_limit' => '<strong>%s</strong> digital wallets',
    ...
    'global.plan_settings.ai_static_prompts_per_month_limit' => '<strong>%s</strong> AI site generations <span class="small text-muted">/ month</span>',
    ...
    'global.plan_settings.notification_handlers_sixsixtext_send_sms_limit' => '%s own device - send SMS handlers',
    'global.plan_settings.notification_handlers_sixsixtext_save_contact_limit' => '%s own device - save contact handlers',
    ...
    'dashboard.vcard_links' => 'vcard links',
    'dashboard.event_links' => 'event links',
    'dashboard.biolinks' => 'biolinks',
    ...
    'index.chrome_extension.name' => 'Chrome extension',
    'index.chrome_extension.header' => 'Quick shortening within Chrome',
    'index.chrome_extension.subheader' => 'Shorten links from Chrome instantly with our lightweight extension. Use the popup, right-click menu, and quick access to recent links.',
    'index.chrome_extension.install' => 'Install on Chrome',
    'index.chrome_extension.learn' => 'Learn more',
    'index.chrome_extension.domains' => 'Custom domains',
    'index.chrome_extension.context_menu' => 'Right-click shortening',
    'index.chrome_extension.last_shortened' => 'History access',
    'index.chrome_extension.custom_alias' => 'Custom alias',
    'index.chrome_extension.shortcut' => 'Keyboard shortcut',
    'index.chrome_extension.shortcut_help' => 'CTRL/CMD + SHIFT + L',
    ...
    'api_documentation.authentication.subheader' => 'All the API requests require authentication through an API key sent via the <code>Authorization</code> header as shown below.',
    ...
    'chrome_extension.breadcrumb' => 'Chrome extension',
    'chrome_extension.title' => 'Chrome extension',
    'chrome_extension.menu' => 'Chrome extension',
    'chrome_extension.header' => 'Get the chrome extension',
    'chrome_extension.subheader' => 'Download, install & connect to our chrome extension.',
    'chrome_extension.download' => 'Install extension',
    'chrome_extension.connect' => 'Already installed? %s API key details automatically.',
    'chrome_extension.connect_button' => '<code class="font-weight-bold">Connect extension</code>',
    'chrome_extension.connected' => 'Connected',
    'chrome_extension.not_connected' => 'Connection failed, insert details manually',
    'chrome_extension.api_key' => 'API key',
    'chrome_extension.site_url' => 'Site URL',

    'chrome_extension.popup.header' => 'Easy shortening',
    'chrome_extension.popup.subheader' => 'Paste any URL into the extension popup and shorten it in seconds.',
    'chrome_extension.popup.image_alt' => 'Screenshot of the chrome extension popup shortening form',
    'chrome_extension.context_menu.header' => 'Right-click shortening',
    'chrome_extension.context_menu.subheader' => 'Shorten links straight from the context menu without opening the dashboard.',
    'chrome_extension.context_menu.image_alt' => 'Screenshot of the chrome extension right click context menu shortening feature',
    'chrome_extension.last_shortened.header' => 'History access',
    'chrome_extension.last_shortened.subheader' => 'See your most recently shortened URLs and copy them again whenever needed.',
    'chrome_extension.last_shortened.image_alt' => 'Screenshot of the chrome extension last shortened URLs feature',
    'chrome_extension.domains.header' => 'Custom domains',
    'chrome_extension.domains.subheader' => 'Choose from your available custom domains, right inside the extension.',
    'chrome_extension.domains.image_alt' => 'Screenshot of the chrome extension custom domain picker',
    'chrome_extension.settings.header' => 'Personalize',
    'chrome_extension.settings.subheader' => 'Adjust the extension settings to match your workflow.',
    'chrome_extension.settings.image_alt' => 'Screenshot of the chrome extension settings section',
    'chrome_extension.shortcut.header' => 'Keyboard shortcut',
    'chrome_extension.shortcut.subheader' => 'Shorten the current page instantly by pressing <strong>CTRL/CMD + SHIFT + L</strong>',
    'chrome_extension.shortcut.image_alt' => 'Screenshot of the chrome extension web push notification from a shortcut shortening',

    'chrome_extension.faq.header' => 'Frequently asked questions',
    'chrome_extension.faq.install.question' => 'How do I install the Chrome extension?',
    'chrome_extension.faq.install.answer' => 'Install it from the Chrome Web Store, then pin it to your browser toolbar for quick access.',
    'chrome_extension.faq.login.question' => 'Do I need an account to use it?',
    'chrome_extension.faq.login.answer' => 'Yes, you need an account to connect the extension and create short links from your browser.',
    'chrome_extension.faq.shorten.question' => 'What can I shorten with the extension?',
    'chrome_extension.faq.shorten.answer' => 'You can shorten page URLs, selected links, and pasted URLs directly from the extension popup or right-click menu.',
    'chrome_extension.faq.history.question' => 'Can I see my recently shortened links?',
    'chrome_extension.faq.history.answer' => 'Yes, the extension shows your latest shortened URLs so you can quickly copy and reuse them.',
    'chrome_extension.faq.permissions.question' => 'Why does the extension need browser permissions?',
    'chrome_extension.faq.permissions.answer' => 'Permissions are required so the extension can read the current page URL, use the context menu, and shorten links when you request it.',
    'chrome_extension.faq.free.question' => 'Is the Chrome extension free to use?',
    'chrome_extension.faq.free.answer' => 'Yes, the extension is included with your account at no extra cost.',
    'chrome_extension.faq.compatibility.question' => 'Which browsers are supported?',
    'chrome_extension.faq.compatibility.answer' => 'The extension is built for Google Chrome and other Chromium-based browsers that support Chrome extensions.',
    'chrome_extension.faq.sync.question' => 'Are my links synced with my account?',
    'chrome_extension.faq.sync.answer' => 'Yes, links created with the extension are connected to your account and available in your dashboard.',

    'directory.breadcrumb' => 'Directory',
    'directory.title' => 'Directory',
    'directory.menu' => 'Directory',
    'directory.header' => 'Explore our bio pages',
    ...
    'guests_payments.simple_notification' => 'New payment received for \'%1$s\'.%4$s🔗 View payment: %5$s.',
    'guests_payments.push_notification.title' => '%1$s sold for %2$s %3$s',
    ...
    'projects.email_reports_is_enabled_help' => 'Receive simple and easy to understand analytics for all the links in this project via email.',
    ...
    'digital_wallets.title' => 'Digital wallets',
    'digital_wallets.menu' => 'Digital wallets',
    'digital_wallets.breadcrumb' => 'Digital wallets',
    'digital_wallets.header' => 'Digital wallets',
    'digital_wallets.subheader' => 'Create Digital Wallet cards that people can save directly to their wallet.',
    'digital_wallets.create' => 'Create digital wallet',
    'digital_wallets.digital_wallet_id' => 'Digital wallet',
    'digital_wallets.custom' => 'Custom',
    'digital_wallets.name_help' => 'Internal name used to identify this wallet card in your account.',
    'digital_wallets.title_help' => 'Main text displayed on the Digital Wallet card.',
    'digital_wallets.logo' => 'Logo',
    'digital_wallets.image' => 'Hero image',
    'digital_wallets.image_help' => 'Wide banner shown at the top of the Digital Wallet card. Recommended aspect ratio: 3:1.',
    'digital_wallets.subtitle' => 'Subtitle',
    'digital_wallets.subtitle_help' => 'Optional supporting text shown below the title.',
    'digital_wallets.background_color' => 'Background color',
    'digital_wallets.website' => 'Website',
    'digital_wallets.link_id' => 'Linked URL',
    'digital_wallets.link_id_help' => 'Optionally choose one of your existing links. Its destination URL will be used automatically.',
    'digital_wallets.location_url_help' => 'This URL is used for the Digital Wallet QR code and main action.',
    'digital_wallets.details' => 'Details',
	'digital_wallets.contact' => 'Contact',
	'digital_wallets.wallet.open_website' => 'Open website',
    'digital_wallets.google_wallet' => 'Google Wallet',
    'digital_wallets.apple_wallet' => 'Apple Wallet',
    'digital_wallets.share_google_wallet' => 'Share Google Wallet link',
    'digital_wallets.share_apple_wallet' => 'Share Apple Wallet link',
    'digital_wallets.apple_wallet_error' => 'The Apple Wallet pass could not be generated. Please try again later.',
    'digital_wallets.apple_wallet_signature_error' => 'The Apple Wallet pass could not be signed.',
    'digital_wallets.apple_wallet_package_error' => 'The Apple Wallet pass package could not be created.',
    'digital_wallets.no_data' => 'No existing wallet cards',


    'digital_wallet_create.breadcrumb' => 'Create digital wallet',
    'digital_wallet_create.title' => 'Create digital wallet',
    'digital_wallet_create.header' => 'Create digital wallet',


    'digital_wallet_update.breadcrumb' => 'Edit digital wallet',
    'digital_wallet_update.title' => 'Edit digital wallet',
    'digital_wallet_update.header' => 'Edit digital wallet',
    ...
    'qr_codes.input.url_dynamic_existing_link' => 'Select from pre-existing links',
    'qr_codes.input.url_dynamic_existing_link_help' => 'Use one of your existing short links instead of creating a new one when saving this QR code.',
    ...
    'link.settings.seo_block_help' => 'Block your link from being indexed by search engines.',
    ...
    'link.static.ai_generate' => 'Generate with AI',
    'link.static.upload' => 'Upload site',
    ...
    'link.biolink.blocks.digital_wallet' => 'Digital Wallet',
    ...
    'create_static_modal.ai_input' => 'AI prompt',
    'create_static_modal.ai_input_placeholder' => 'Generate a modern-looking landing page for a local GYM business named Iron District...',
    ...
    'biolink_socials.bandcamp.placeholder' => 'Bandcamp username',
    ...
    'biolink_socials.kick.placeholder' => 'Kick username',
	...
	'biolink_bandcamp.header' => 'Add a Bandcamp Music Player',
	'biolink_bandcamp.subheader' => 'Display a customizable album or track player on your page.',
	...
	'biolink_bandcamp.type.small' => 'Small',
	'biolink_bandcamp.type.large' => 'Large',
	'biolink_bandcamp.display_track_list' => 'Display track list',
	'biolink_bandcamp.display_artwork' => 'Display artwork',
    ...
    'biolink_digital_wallet.header' => 'Add a Digital Wallet button',
    'biolink_digital_wallet.subheader' => 'Display a wallet add button on your page.',
    'biolink_digital_wallet.digital_wallet_id' => 'Digital wallet',
    'biolink_digital_wallet.wallet_provider' => 'Wallet provider',
    'biolink_digital_wallet.wallet_provider_both' => 'Google Wallet and Apple Wallet',
    ...
    'biolink_appointment_calendar.date' => 'Date',
    'biolink_appointment_calendar.time' => 'Time',
    'biolink_appointment_calendar.duration' => 'Duration',
    ...
    'biolink_block.data_help' => 'All collected data can be found in the %sData page%s.',
	...
	'biolink_block.simple_notification' => 'New submission received.%1$s🔗 View submission: %2$s.',
	'biolink_block.push_notification.title' => 'New submission',
    ...
    'tools.private' => 'Privacy focused',
    'tools.instant' => 'Instant results',
    'tools.simple' => 'Simple interface',
    ...
    'tools.whois_lookup.result.domain_age' => 'Domain age',
    ...
    'notification_handlers.type_sixsixtext_send_sms' => 'Own device - send SMS',
    'notification_handlers.type_sixsixtext_save_contact' => 'Own device - save contact',
    ...
    'notification_handlers.sixsixtext_api_key' => '%s API key',
    'notification_handlers.sixsixtext_api_key_help' => 'The API key of your account on %s.',
    'notification_handlers.sixsixtext_device_id' => 'Device ID',
	'notification_handlers.sixsixtext_device_sim_subscription_id' => 'Device SIM subscription ID',
	'notification_handlers.sixsixtext_phone_number' => 'Phone number',
	'notification_handlers.sixsixtext_phone_number_placeholder' => '+12345678900',
	'notification_handlers.sixsixtext_test_phone_number' => 'Test phone number',
	'notification_handlers.sixsixtext_test_phone_number_help' => 'This phone number is only used to test the notification handlers connection with the button below.',
    ...
    'signatures.border_radius' => 'Signature border radius',
    'signatures.background_color' => 'Background color',
    'signatures.border_color' => 'Border color',
	...
	'signatures.create_info' => 'All customization options available after creation.',
    ...
    'signature_update.tab.themes' => 'Themes',
    ...
    'signature_update.theme_apply' => 'Apply theme',
    ...
    'cron.projects_email_reports.title' => 'Summary analytics for the \'{{PROJECT:NAME}}\' project between {{START_DATE}} and {{END_DATE}} - {{WEBSITE_TITLE}}',
    'cron.projects_email_reports.p1' => 'Short analytics overview for the <strong>%s</strong> project.',
    'cron.projects_email_reports.links' => 'Links overview',
    'cron.projects_email_reports.button' => 'View project statistics',
    'cron.projects_email_reports.notice' => 'You\'re receiving these emails because you activated project email reports. You can unsubscribe from the %sproject settings%s page at any point in time.',
    'index.claim_url_available' => 'This URL is available!',
    'index.claim_url_available_title' => 'URL Available',
    'index.claim_url_used' => 'This URL is already taken.',
    'index.claim_url_used_title' => 'URL Taken',
    'index.claim_url_banned' => 'This URL is not allowed. Please choose a different one.',
    'index.claim_url_visit' => 'Visit URL',
    ...
    'link.settings.explore_things_header' => 'Explore Things',
    'link.settings.explore_things_help' => 'This section shows whether your biolink is featured in the "Explore Things" section of the directory. This is set by administrators and cannot be requested by users.',
    'link.settings.explore_things_status' => 'Featured in Explore Things',
    'link.settings.explore_things_status_help' => 'If enabled, your biolink will appear in the directory for logged-in users under "Explore Things".',
