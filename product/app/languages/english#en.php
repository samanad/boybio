...
return [
    ...
    'link.settings.tools.favicon' => 'Favicon',
    'link.settings.tools.favicon_help' => 'Shows the page favicon as a pinned avatar at the top. It stays there and gets smaller when you scroll.',
    'link.settings.tools.tag' => 'Tag',
    'link.settings.tools.tag_help' => 'Show other related biolink pages (opponents) on this page.',
    'link.settings.tools.tag_hide_content' => 'Hide this page content',
    'link.settings.tools.tag_hide_content_help' => 'If checked, visitors only see the related pages. If not, they see those pages and this page too.',
    'link.settings.tools.tag_pages' => 'Related pages',
    'link.settings.tools.tag_pages_help' => 'Choose other biolink pages to tag as related to this one.',
    'link.settings.tools.tag_pages_empty' => 'No other biolink pages yet.',
