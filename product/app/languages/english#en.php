...
return [
    ...
    'account_backup.export.offload_help' => 'First shows the size. Media already on Cloudflare is stored as URLs only. Files that still live on this server are packed into the zip.',
