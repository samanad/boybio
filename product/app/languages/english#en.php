...
return [
    ...
    'link.settings.tools_help' => 'Turn on one or two tools for this page. Password can stay on at the same time. Visitors see them when they open the page.',
    ...
    'link.settings.tools.password' => 'Password (private / public)',
    'link.settings.tools.password_help' => 'The page stays public so others can see it. Visitors type the password to open private information. The lock at the top switches to private-only.',
    'link.settings.tools.password_secret' => 'Password',
    'link.settings.tools.password_secret_help' => 'Leave empty to keep the current password.',
    'link.settings.tools.password_content' => 'Private information',
    'link.settings.tools.password_content_help' => 'Shown after the visitor types this password.',
