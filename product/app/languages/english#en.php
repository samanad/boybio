...
return [
    ...
    'account.security_key.header' => 'Security keys',
    'account.security_key.subheader' => 'Use a hardware security key (YubiKey, Titan, and similar FIDO2 keys) to sign in without a password.',
    'account.security_key.name' => 'Key name',
    'account.security_key.name_placeholder' => 'e.g. YubiKey 5',
    'account.security_key.add' => 'Add security key',
    'account.security_key.empty' => 'No security keys registered yet.',
    'account.security_key.default_name' => 'Security key',
    'account.security_key.last_used' => 'Last used: %s',
    'account.security_key.never_used' => 'Never used',
    'account.security_key.unsupported' => 'This browser does not support security keys.',
    'account.security_key.error_message.register' => 'The security key could not be registered. Try again.',
    'account.security_key.error_message.exists' => 'This security key is already registered.',
    'account.security_key.success_message.registered' => 'Security key registered.',
    'account.security_key.success_message.deleted' => 'Security key removed.',
    'account.security_key.delete_confirm' => 'Remove this security key?',
    ...
    'account_backup.title' => 'Account backup',
    'account_backup.menu' => 'Backup',
    'account_backup.header' => 'Export & import',
    'account_backup.subheader' => 'Save this account (settings, biolinks, blocks) to a zip you can restore here or on another Cloub / 66biolinks site.',
    'account_backup.export.header' => 'Export',
    'account_backup.export.help' => 'The zip keeps original IDs so import can recreate the same biolinks. CSV / JSON / PDF list export is separate and cannot restore pages.',
    'account_backup.export.pc' => 'Export to PC',
    'account_backup.export.pc_help' => 'First shows how big the backup would be. You can leave out files over 50 MB, then create the zip.',
    'account_backup.export.offload' => 'Export to Cloudflare (Offload)',
    'account_backup.export.offload_help' => 'Saves the zip in this account\'s folder on Cloudflare (Offload). That copy stays there so you can download or restore it later.',
    'account_backup.export.job.offload_kept' => 'A copy is also stored in this account\'s Cloudflare folder for later download.',
    'account_backup.export.preview.header' => 'Backup size',
    'account_backup.export.preview.help' => 'These counts come from the database only. Tick exclude files over 50 MB, then create. The zip is built in the background so other pages stay up.',
    'account_backup.export.preview.size' => 'Measured size of files that would go into the zip',
    'account_backup.export.preview.counts_note' => 'Exact byte size is not scanned here (that hung the site). Files over 50 MB are skipped during create if the box is ticked.',
    'account_backup.export.preview.other' => 'Other media',
    'account_backup.export.preview.size_unknown' => '%s files were not measured (images and other small files). They are included unless they are over 50 MB.',
    'account_backup.export.preview.large_header' => 'Files larger than 50 MB',
    'account_backup.export.preview.large_none' => 'No measured file is over 50 MB.',
    'account_backup.export.preview.size_if_excluded' => 'Size if files over 50 MB are left out',
    'account_backup.export.preview.exclude_large' => 'Exclude files larger than 50 MB',
    'account_backup.export.preview.exclude_large_help' => 'Those files stay as URLs in the backup. The zip stays smaller and is less likely to time out.',
    'account_backup.export.preview.create' => 'Create backup',
    'account_backup.export.job.started' => 'Backup is being created in the background. This page will stay up. Refresh in a minute and download the zip when it is ready.',
    'account_backup.export.job.already' => 'A backup is already being created. Refresh this page and wait for it to finish.',
    'account_backup.export.job.running' => 'Creating the backup now. 500 MB and a thousand files take several minutes. This page refreshes by itself.',
    'account_backup.export.job.done' => 'Backup is ready: %s (%s)',
    'account_backup.export.job.error' => 'Backup failed: %s',
    'account_backup.export.job.download' => 'Download zip',
    'account_backup.export.local.header' => 'Zips on this server',
    'account_backup.import.header' => 'Import',
    'account_backup.import.help' => 'Choose how to restore. You will see a review if something cannot be copied as-is.',
    'account_backup.mode.create' => 'Create a new account from this backup',
    'account_backup.mode.create_help' => 'The site opens a new account and copies all account information from the file, except what is impossible here (taken email, missing plan, IDs already used by someone else).',
    'account_backup.mode.merge' => 'Add to this account',
    'account_backup.mode.merge_help' => 'Your current name, email, password and existing biolinks stay as they are. Items from the file are added on top. Nothing already on this account is overwritten.',
    'account_backup.restore.header' => 'Restore backup',
    'account_backup.restore.subheader' => 'Upload a Cloub backup zip. The site will create a new account from that file.',
    'account_backup.restore.submit' => 'Create account from backup',
    'account_backup.review.subheader_create' => 'A new account will be created. Everything possible is copied from the file. Impossible items are listed below.',
    'account_backup.review.subheader_merge' => 'This account stays as it is. Backup items are added on top. Existing rows are not changed.',
    'account_backup.review.confirm_create' => 'Create the account',
    'account_backup.review.confirm_merge' => 'Add to this account',
    'account_backup.import.email_override' => 'Use a different email for the new account',
    'account_backup.import.email_override_help' => 'Required if the backup email is already registered on this site.',
    'account_backup.conflict.email_taken_create' => 'Email %s is already used on this site, so a new account cannot use it. Enter another email below.',
    'account_backup.conflict.merge_account' => 'This account\'s profile (name, email, password, plan, existing biolinks) will not be changed. Only missing items from the backup are added.',
    'account_backup.conflict.id_exists_own_merge' => '%s records from the backup already exist on this account (%s). They will be left as they are.',
    'account_backup.success.created' => 'A new account was created for %s. You can log in with the password from the backup.',
    'account_backup.success.created_logged_in' => 'Account created for %s. You are now logged in. Use the backup password next time.',
    'account_backup.success.merged' => 'Backup items were added on top of this account. Existing information was not changed.',
    'account_backup.error.email_taken' => 'That email is already registered. Use a different email.',
    'account_backup.error.email_invalid' => 'Enter a valid email for the new account.',
    'account_backup.error.password_missing' => 'This backup has no password hash, so a new account cannot be created from it.',
    'account_backup.error.account_create_failed' => 'The new account could not be created.',
    'account_backup.option.override' => 'Use the email entered above',
    'account_restore.title' => 'Restore backup',
    'account_backup.import.file' => 'Backup zip',
    'account_backup.import.from_pc' => 'Import from PC',
    'account_backup.import.from_cloud' => 'A zip already exported to Cloudflare',
    'account_backup.import.choose_cloud' => 'Choose a backup',
    'account_backup.import.load_cloud' => 'Load from Cloudflare',
    'account_backup.review.header' => 'Review before restore',
    'account_backup.review.subheader' => 'Choose what to do for each mismatch, then confirm. Same IDs are kept when they are free.',
    'account_backup.review.source' => 'Exported from',
    'account_backup.review.plan' => 'Plan in backup',
    'account_backup.review.links' => 'Links / biolinks',
    'account_backup.review.blocks' => 'Biolink blocks',
    'account_backup.review.media' => 'Media files',
    'account_backup.review.destination_mode' => 'Export type',
    'account_backup.review.needs_choice' => 'Choose',
    'account_backup.review.info' => 'Info',
    'account_backup.review.confirm' => 'Import into this account',
    'account_backup.log.title' => 'Last import result',
    'account_backup.success.exported_offload' => 'Account folder created on Cloudflare if needed. Backup saved in %s as %s',
    'account_backup.success.imported' => 'Backup imported into this account.',
    'account_backup.info.cancelled' => 'Import cancelled. Nothing was changed.',
    'account_backup.error.offload_not_ready' => 'The Offload plugin is not active or has no uploads URL. Set it under Admin → Settings → Offload (S3 / Cloudflare R2).',
    'account_backup.error.invalid_zip' => 'That file is not a valid zip.',
    'account_backup.error.invalid_package' => 'That zip is not a Cloub account backup.',
    'account_backup.error.no_file' => 'Choose a backup file or a Cloudflare zip first.',
    'account_backup.conflict.email_taken' => 'Backup email %s is already used on this site, so it cannot be copied onto this account.',
    'account_backup.conflict.email_different' => 'Backup email is %s and this account is %s.',
    'account_backup.conflict.credentials' => 'Import password, 2FA secret, API key and referral key from the backup? Default is to keep this account\'s login details.',
    'account_backup.conflict.plan_different' => 'Backup plan is %s and this account is on %s.',
    'account_backup.conflict.plan_missing' => 'Backup plan %s does not exist on this site. This account will keep its current plan.',
    'account_backup.conflict.id_exists_own' => '%s records already exist in this account with the same IDs (%s). Replace them or skip those rows.',
    'account_backup.conflict.id_exists_other' => '%s IDs already belong to another account (%s). They cannot stay the same. Skip those rows or give them new IDs.',
    'account_backup.conflict.slug_taken' => '%s short URLs are already taken (%s). Skip them or add a suffix.',
    'account_backup.conflict.domain_taken' => '%s custom domains are already used on this site (%s). They will be skipped and biolinks will use the main domain.',
    'account_backup.conflict.missing_tables' => 'These tables are in the backup but missing on this site, so they will be skipped: %s.',
    'account_backup.conflict.missing_theme' => 'These biolink theme IDs are not on this site and will be cleared: %s.',
    'account_backup.conflict.missing_media' => '%s media files are not in the zip and have no Cloudflare URL. Rows will still import; those files may be missing.',
    'account_backup.conflict.missing_domain' => 'Custom domains that do not exist for this account will be reset to the main site domain.',
    'account_backup.option.keep' => 'Keep this account\'s value',
    'account_backup.option.import' => 'Use the value from the backup',
    'account_backup.option.skip' => 'Skip those rows',
    'account_backup.option.replace' => 'Replace this account\'s rows (same IDs)',
    'account_backup.option.new_id' => 'Import with new IDs',
    'account_backup.option.suffix' => 'Import with a suffix on the URL',
    'account_backup.option.default' => 'Use the default theme',
    'account_backup.option.main' => 'Use the main domain',
    'account_backup.option.continue' => 'Continue anyway',
    ...
    'login.security_key' => 'Sign in with security key',
    'login.security_key.error_message' => 'Security key sign-in failed. Try again or use your password.',
    ...
    'link.settings.tools_header' => 'Tools',
    'link.settings.tools_help' => 'Turn on one or two tools for this page. Visitors see them when they open the page.',
    'link.settings.tools.magnifier' => 'Magnifier',
    'link.settings.tools.magnifier_help' => 'Larger text for people who do not see well.',
    'link.settings.tools.magnifier_light' => 'Light',
    'link.settings.tools.magnifier_advanced' => 'Advanced',
    'link.settings.tools.caffeine' => 'Caffeine',
    'link.settings.tools.caffeine_help' => 'Keep the screen on while the page is open.',
    'link.settings.tools.contrast' => 'Contrast',
    'link.settings.tools.contrast_help' => 'High contrast black and white display.',
    'link.settings.tools.rain' => 'Rain',
    'link.settings.tools.rain_help' => 'Light rain falling over the page.',
    'link.settings.tools.snow' => 'Snow',
    'link.settings.tools.snow_help' => 'Light snow falling over the page.',
    'link.settings.tools.night' => 'Night',
    'link.settings.tools.night_help' => 'Dim the screen with a warm filter.',
    'link.settings.tools.heaven' => 'Heaven',
    'link.settings.tools.heaven_help' => 'Soft overlay. Shows “this is heaven”, “part of it”, or “in it”.',
    'link.settings.tools.blocked' => 'Blocked',
    'link.settings.tools.blocked_help' => 'Shows the lines “he banned me” and “i blocked him”.',
    'link.settings.tools.up_to_grow' => 'Up to grow',
    'link.settings.tools.up_to_grow_help' => 'Shows the words “up to grow” with simple growth pictures.',
    'link.settings.tools.under_control' => 'Under control',
    'link.settings.tools.under_control_help' => 'Status bar that reads “Under control”.',
    'link.settings.tools.earthquake' => 'Earthquake',
    'link.settings.tools.earthquake_help' => 'Shakes the page and uses phone vibration when the device allows it.',
    'link.settings.tools.war' => 'War',
    'link.settings.tools.war_help' => 'A small stamp on the page.',
    'link.settings.tools.secure' => 'Secure',
    'link.settings.tools.secure_help' => 'A simple secure bar at the top of the page.',
    'link.settings.tools.tap' => 'Tap',
    'link.settings.tools.tap_help' => 'Circles appear to tap while waiting. No score.',
    'link.settings.tools.screensaver' => 'Screensaver',
    'link.settings.tools.screensaver_help' => 'Covers the page with a simple waiting screen.',
