...
return [
    ...
    'account_backup.export.pc_help' => 'Download a zip. Media on Cloudflare is downloaded into the zip. Files still on this server are copied in too.',
    'account_backup.export.offload' => 'Export to Cloudflare (Offload)',
    'account_backup.export.offload_help' => 'Creates a folder for this account on Cloudflare (Offload) and stores the zip there. Media already on Cloudflare is stored as URLs only. Files that still live on this server are packed into the zip.',
