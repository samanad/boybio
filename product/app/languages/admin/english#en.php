...
return [
    ...
    'admin_settings.users.blacklisted_countries_help' => 'Select the countries that you want to block site-wide (pages, biolinks, login, register, admin, etc.). Detection is IP based.',
    'admin_settings.users.country_ban_bypass_hostnames' => 'Country ban bypass hostnames',
