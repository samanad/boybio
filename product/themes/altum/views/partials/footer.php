...
<div class="d-flex flex-column flex-lg-row justify-content-between mb-3">
    <div class="mb-3 mb-lg-0">
        <a
            ...
            data-light-class="<?= !empty(settings()->main->logo_light) ? 'mb-2 footer-logo' : 'mb-2' ?>"
...
<div class="row">
    <div class="col-12 col-lg mb-3 mb-lg-0">
        <ul class="list-style-none d-flex flex-column flex-lg-row flex-wrap m-0">
            ...
            <?php 
            // Fallback: If pages aren't loading from database, show hardcoded links
            // Remove this block once database pages are working
            if(empty($data->pages) || count($data->pages) == 0): 
                $fallback_pages = [
                    ['url' => 'https://biolink.dev', 'title' => 'built with love', 'target' => '_blank'],
                    ['url' => 'https://saman.host', 'title' => 'from saman', 'target' => '_blank']
                ];
