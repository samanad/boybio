...
<div class="app-sidebar">
    ...
    <div class="app-sidebar-links-wrapper flex-grow-1">
        <ul class="app-sidebar-links">
            ...
            <?php if(settings()->links->biolinks_is_enabled && settings()->links->directory_is_enabled && ((settings()->links->directory_access ?? 'everyone') == 'everyone' || ((settings()->links->directory_access ?? '') == 'users' && is_logged_in()))): ?>
