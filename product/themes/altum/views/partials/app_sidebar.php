    ...
    <div class="app-sidebar-links-wrapper flex-grow-1">
        <ul class="app-sidebar-links">
            <?php if(is_logged_in()): ?>
                ...
                <?php if(isset(settings()->codes) && settings()->codes->qr_codes_is_enabled): ?>
            ...
            <?php if(settings()->links->biolinks_is_enabled && settings()->links->directory_is_enabled && (!biolinks_discovery_is_prevented() || ($this->user->type ?? null) == 1)): ?>
        ...
        <div class="app-sidebar-footer dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                <?php if(!\Altum\Teams::is_delegated()): ?>
                    ...
                    if($sso_settings && isset($sso_settings->is_enabled) && $sso_settings->is_enabled && isset($sso_settings->display_menu_items) && $sso_settings->display_menu_items && isset($sso_settings->websites) && count((array) $sso_settings->websites)): ?>
                        <div class="dropdown-divider"></div>
