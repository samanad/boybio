...
<form action="" method="post" class="mt-4" role="form">
    ...
    <?php if((isset(settings()->facebook->is_enabled) && settings()->facebook->is_enabled) || (isset(settings()->google->is_enabled) && settings()->google->is_enabled) || (isset(settings()->twitter->is_enabled) && settings()->twitter->is_enabled) || (isset(settings()->discord->is_enabled) && settings()->discord->is_enabled) || (isset(settings()->linkedin->is_enabled) && settings()->linkedin->is_enabled) || (isset(settings()->microsoft->is_enabled) && settings()->microsoft->is_enabled)): ?>
        ...
        <div>
            <?php if(isset(settings()->facebook->is_enabled) && settings()->facebook->is_enabled): ?>
                <div class="mt-2">
            ...
            <?php endif ?>
            <?php if(isset(settings()->twitter->is_enabled) && settings()->twitter->is_enabled): ?>
                <div class="mt-2">
            ...
            <?php endif ?>
            <?php if(isset(settings()->discord->is_enabled) && settings()->discord->is_enabled): ?>
                <div class="mt-2">
...
<?php endif ?>
    ...
    <div class="mt-3 text-center text-muted">
        <a href="<?= url('account-restore') ?>" class="font-weight-bold"><?= l('account_backup.restore.header') ?></a>
        <div class="small"><?= l('account_backup.restore.subheader') ?></div>
    </div>
