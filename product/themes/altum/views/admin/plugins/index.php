                    ...
                    <div class="card-body d-flex justify-content-between flex-column position-relative">
                        ...
                        <div class="d-flex align-items-center justify-content-center mt-4">
                            <?php if($plugin->status !== -2 && $plugin->status != 'inexistent'): ?>
                                <?php if(isset($plugins_info) && isset($plugins_info->{$plugin->plugin_id}) && isset($plugins_info->{$plugin->plugin_id}->version) && $plugins_info->{$plugin->plugin_id}->version != $plugin->version): ?>
