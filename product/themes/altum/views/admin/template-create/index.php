...
<nav aria-label="breadcrumb">
    <ol class="custom-breadcrumbs small">
        <li>
            <a href="<?= url('admin/templates') ?>"><?= l('admin_templates.breadcrumb') ?></a><i class="fas fa-fw fa-angle-right"></i>
        </li>
        <li class="active" aria-current="page"><?= l('admin_template_create.breadcrumb') ?></li>
    </ol>
</nav>
<?php endif ?>
...
<div class="card <?= \Altum\Alerts::has_field_errors() ? 'border-danger' : null ?>">
    <div class="card-body">
        <form action="" method="post" role="form">
                    ...
                    <?php foreach(\Altum\Language::$active_languages as $language_name => $language_code): ?>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="<?= 'translation_' . $language_name . '_name' ?>" name="<?= 'translations[' . $language_name . '][name]' ?>" class="form-control" maxlength="64" required="required" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="<?= 'translation_' . $language_name . '_description' ?>" name="<?= 'translations[' . $language_name . '][description]' ?>" class="form-control" maxlength="256" required="required" />
                            </div>
                        </div>
                    <?php endforeach ?>
                </div>
            ...
            <div class="form-group">
                <label for="template_category_id"><i class="fas fa-fw fa-sm fa-folder text-muted mr-1"></i> <?= l('admin_templates_categories.main.template_category_id') ?></label>
            ...
            <div class="form-group">
                ...
                <textarea id="prompt" name="prompt" class="form-control" placeholder="<?= l('admin_templates.main.prompt_placeholder') ?>" maxlength="5000" required="required"></textarea>
                <small class="form-text text-muted"><?= l('admin_templates.main.prompt_help') ?></small>
            </div>

            <div class="form-group">
                <h2 class="h6"><i class="fas fa-fw fa-sm fa-keyboard text-muted mr-1"></i> <?= l('admin_templates.main.inputs') ?></h2>
                <div id="inputs">
                    <div class="p-3 bg-gray-50 rounded mb-4" data-input>
                        <div class="form-row">
                            <div class="form-group col-lg">
                                <label for="input_key_0"><i class="fas fa-fw fa-sm fa-key text-muted mr-1"></i> <?= l('admin_templates.main.input.key') ?></label>
                                <input id="input_key_0" type="text" name="inputs[0][key]" class="form-control" placeholder="<?= l('admin_templates.main.input.key_placeholder') ?>" />
                            </div>

                            <div class="form-group col-lg">
                                <label for="input_type_0"><i class="fas fa-fw fa-sm fa-fingerprint text-muted mr-1"></i> <?= l('admin_templates.main.input.type') ?></label>
                                <select id="input_type_0" name="inputs[0][type]" class="custom-select">
                            ...
                            <div class="form-group col-lg">
                                <label for="input_icon_0"><i class="fas fa-fw fa-sm fa-icons text-muted mr-1"></i> <?= l('global.icon') ?></label>
                                <input id="input_icon_0" type="text" name="inputs[0][icon]" class="form-control" placeholder="<?= l('global.icon_placeholder') ?>" />
                            </div>
                        </div>
                        ...
                        <?php foreach(\Altum\Language::$active_languages as $language_name => $language_code): ?>
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="<?= 'input_translation_' . $language_name . '_name_0' ?>" name="<?= 'inputs[0][translations][' . $language_name . '][name]' ?>" class="form-control" maxlength="128" required="required" />
                                </div>
                            </div>
                        <?php endforeach ?>
                        ...
                        <?php foreach(\Altum\Language::$active_languages as $language_name => $language_code): ?>
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="<?= 'input_translation_' . $language_name . '_placeholder_0' ?>" name="<?= 'inputs[0][translations][' . $language_name . '][placeholder]' ?>" class="form-control" maxlength="128" />
                                </div>
                            </div>
                        <?php endforeach ?>
                        ...
                        <?php foreach(\Altum\Language::$active_languages as $language_name => $language_code): ?>
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="<?= 'input_translation_' . $language_name . '_help_0' ?>" name="<?= 'inputs[0][translations][' . $language_name . '][help]' ?>" class="form-control" maxlength="128" />
                                </div>
                            </div>
                        <?php endforeach ?>

                        <button type="button" data-remove="input" class="btn btn-block btn-outline-danger"><i class="fas fa-sm fa-fw fa-times mr-1"></i> <?= l('global.delete') ?></button>
                    </div>
                </div>

                <div class="mb-3">
                    <button data-add="input" type="button" class="btn btn-block btn-outline-success"><i class="fas fa-sm fa-fw fa-plus-circle mr-1"></i> <?= l('global.create') ?></button>
                </div>
            </div>

            <div class="form-group">
                <label for="icon"><i class="fas fa-fw fa-sm fa-icons text-muted mr-1"></i> <?= l('global.icon') ?></label>
                <input type="text" id="icon" name="icon" class="form-control" maxlength="64" placeholder="<?= l('global.icon_placeholder') ?>" required="required" />
...
<template id="template_input">
    <div class="p-3 bg-gray-50 rounded mb-4" data-input>
        <div class="form-row">
            <div class="form-group col-lg">
                <label for="input_key_INCREMENT"><i class="fas fa-fw fa-sm fa-key text-muted mr-1"></i> <?= l('admin_templates.main.input.key') ?></label>
            ...
            <div class="form-group col-lg">
                <label for="input_type_INCREMENT"><i class="fas fa-fw fa-sm fa-fingerprint text-muted mr-1"></i> <?= l('admin_templates.main.input.type') ?></label>
            ...
            <div class="form-group col-lg">
                <label for="input_icon_INCREMENT"><i class="fas fa-fw fa-sm fa-icons text-muted mr-1"></i> <?= l('global.icon') ?></label>
                <input id="input_icon_INCREMENT" type="text" name="inputs[INCREMENT][icon]" class="form-control" placeholder="<?= l('global.icon_placeholder') ?>" />
            </div>
        </div>
