                    ...
                    <td class="text-nowrap">
                        <div class="d-flex align-items-center">
                            ...
                            <?php if(\Altum\Plugin::is_active('email-signatures')): ?>
                                <a href="<?= url('admin/signatures?project_id=' . $row->project_id) ?>" class="mr-2" data-toggle="tooltip" title="<?= l('signatures.title') ?>">
                                    <i class="fas fa-fw fa-file-signature text-muted"></i>
                                </a>
                            <?php endif ?>

                            <?php if(\Altum\Plugin::is_active('aix')): ?>
                            <a href="<?= url('admin/documents?project_id=' . $row->project_id) ?>" class="mr-2" data-toggle="tooltip" title="<?= l('admin_documents.menu') ?>">
                                <i class="fas fa-fw fa-robot text-muted"></i>
                            </a>

                            <a href="<?= url('admin/images?project_id=' . $row->project_id) ?>" class="mr-2" data-toggle="tooltip" title="<?= l('admin_images.menu') ?>">
                                <i class="fas fa-fw fa-icons text-muted"></i>
                            </a>

                            <a href="<?= url('admin/transcriptions?project_id=' . $row->project_id) ?>" class="mr-2" data-toggle="tooltip" title="<?= l('transcriptions.title') ?>">
