        ...
        <div class="ml-3">
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right d-print-none">
                    <a href="<?= url('admin/data?' . $data->filters->get_get() . '&export=csv') ?>" target="_blank" class="dropdown-item <?= $this->user->plan_settings->export->csv ? null : 'disabled pointer-events-all' ?>" <?= $this->user->plan_settings->export->csv ? null : get_plan_feature_disabled_info() ?>>
...
<form id="table" action="<?= SITE_URL . 'admin/data/bulk' ?>" method="post" role="form">
            ...
            <?php foreach($data->data as $row): ?>
                ...
                <tr>
                    ...
                    <td class="text-nowrap text-muted">
                        <a href="<?= url('admin/links?link_id=' . $row->link_id) ?>" class="mr-2 text-decoration-none" data-toggle="tooltip" title="<?= l('data.biolink') ?>">
                    ...
                    <td>
                        <div class="d-flex justify-content-end">
                            <?= include_view(THEME_PATH . 'views/admin/data/admin_datum_dropdown_button.php', ['id' => $row->datum_id]) ?>
                        </div>
                    </td>
                </tr>
            <?php endforeach ?>
