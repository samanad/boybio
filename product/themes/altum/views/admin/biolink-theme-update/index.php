        ...
        <form action="" method="post" role="form" enctype="multipart/form-data">
            ...
            <div class="collapse" id="biolink_container">
                ...
                <div class="form-group">
                    ...
                    <div class="row btn-group-toggle" data-toggle="buttons">
                        ...
                        <?php foreach(['smooth', 'instant',] as $key): ?>
                            <div class="col-12 col-lg-4 p-2 h-100">
                                <label class="btn btn-light btn-block text-truncate mb-0 <?= ($data->biolink_theme->settings->biolink->hover_animation ?? 'smooth') == $key ? 'active"' : null?>">
                                    <input type="radio" name="biolink_hover_animation" value="<?= $key ?>" class="custom-control-input" <?= ($data->biolink_theme->settings->biolink->hover_animation ?? 'smooth') == $key ? 'checked="checked"' : null?> required="required" />
                ...
                <div class="form-group" data-character-counter="textarea">
                    ...
                    <textarea id="additional_custom_css" class="form-control" name="additional_custom_css" maxlength="10000" rows="5" placeholder="<?= l('global.custom_css_placeholder') ?>" data-code-editor data-mode="css"><?= $data->biolink_theme->settings->additional->custom_css ?></textarea>
                ...
                <div class="form-group" data-character-counter="textarea">
                    ...
                    <textarea id="additional_custom_js" class="form-control" name="additional_custom_js"  maxlength="10000" rows="5" placeholder="<?= l('global.custom_js_placeholder') ?>" data-code-editor data-mode="htmlmixed"><?= $data->biolink_theme->settings->additional->custom_js ?></textarea>
            ...
            <div class="collapse" id="biolink_block_container">
                ...
                <div class="form-group">
                    ...
                    <select id="biolink_block_border_radius" name="biolink_block_border_radius" class="custom-select">
                        <option value="straight" <?= $data->biolink_theme->settings->biolink_block->border_radius == 'straight' ? 'selected="selected"' : null ?>><?= l('biolink_link.border_radius_straight') ?></option>
                        <option value="round" <?= $data->biolink_theme->settings->biolink_block->border_radius == 'round' ? 'selected="selected"' : null ?>><?= l('biolink_link.border_radius_round') ?></option>
                        <option value="rounded" <?= $data->biolink_theme->settings->biolink_block->border_radius == 'rounded' ? 'selected="selected"' : null ?>><?= l('biolink_link.border_radius_rounded') ?></option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="biolink_block_border_style" name="biolink_block_border_style" class="custom-select">
                        <option value="solid" <?= $data->biolink_theme->settings->biolink_block->border_style == 'solid' ? 'selected="selected"' : null ?>><?= l('biolink_link.border_style_solid') ?></option>
                        <option value="dashed" <?= $data->biolink_theme->settings->biolink_block->border_style == 'dashed' ? 'selected="selected"' : null ?>><?= l('biolink_link.border_style_dashed') ?></option>
                        <option value="double" <?= $data->biolink_theme->settings->biolink_block->border_style == 'double' ? 'selected="selected"' : null ?>><?= l('biolink_link.border_style_double') ?></option>
                        <option value="outset" <?= $data->biolink_theme->settings->biolink_block->border_style == 'outset' ? 'selected="selected"' : null ?>><?= l('biolink_link.border_style_outset') ?></option>
                        <option value="inset" <?= $data->biolink_theme->settings->biolink_block->border_style == 'inset' ? 'selected="selected"' : null ?>><?= l('biolink_link.border_style_inset') ?></option>
                    </select>
                </div>
            ...
            <div class="collapse" id="biolink_block_socials_container">
                ...
                <div class="form-group">
                    ...
                    <input id="biolink_block_socials_background_color" type="hidden" name="biolink_block_socials_background_color" class="form-control" value="<?= $data->biolink_theme->settings->biolink_block_socials->background_color ?>" required="required" data-color-picker />
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="biolink_block_socials_border_radius" name="biolink_block_socials_border_radius" class="custom-select">
                        <option value="straight" <?= $data->biolink_theme->settings->biolink_block_socials->border_radius == 'straight' ? 'selected="selected"' : null ?>><?= l('biolink_link.border_radius_straight') ?></option>
                        <option value="round" <?= $data->biolink_theme->settings->biolink_block_socials->border_radius == 'round' ? 'selected="selected"' : null ?>><?= l('biolink_link.border_radius_round') ?></option>
                        <option value="rounded" <?= $data->biolink_theme->settings->biolink_block_socials->border_radius == 'rounded' ? 'selected="selected"' : null ?>><?= l('biolink_link.border_radius_rounded') ?></option>
                    </select>
                </div>
            </div>
            ...
            <div class="collapse" id="biolink_block_paragraph_container">
                ...
                <div class="form-group">
                    ...
                    <input id="biolink_block_paragraph_background_color" type="hidden" name="biolink_block_paragraph_background_color" class="form-control" value="<?= $data->biolink_theme->settings->biolink_block_paragraph->background_color ?>" required="required" data-color-picker />
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="biolink_block_paragraph_border_radius" name="biolink_block_paragraph_border_radius" class="custom-select">
                        <option value="straight" <?= $data->biolink_theme->settings->biolink_block_paragraph->border_radius == 'straight' ? 'selected="selected"' : null ?>><?= l('biolink_link.border_radius_straight') ?></option>
                        <option value="round" <?= $data->biolink_theme->settings->biolink_block_paragraph->border_radius == 'round' ? 'selected="selected"' : null ?>><?= l('biolink_link.border_radius_round') ?></option>
