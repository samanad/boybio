...
<div>
    ...
    <div class="<?= !in_array(settings()->license->type, ['Extended License', 'extended']) ? 'container-disabled' : null ?>">
        ...
        <div class="form-group">
            <label for="secret_key"><i class="fas fa-fw fa-sm fa-lock text-muted mr-1"></i> <?= l('admin_settings.plisio.secret_key') ?></label>
            <input id="secret_key" type="text" name="secret_key" class="form-control" value="<?= settings()->plisio_whitelabel->secret_key ?>" />
        </div>

        <div class="form-group">
            <label for="accepted_cryptocurrencies"><i class="fas fa-fw fa-sm fa-coins text-muted mr-1"></i> <?= l('admin_settings.plisio.accepted_cryptocurrencies') ?></label>
        ...
        <div class="form-group">
            <label for="default_cryptocurrency"><i class="fas fa-fw fa-sm fa-coins text-muted mr-1"></i> <?= l('admin_settings.plisio.default_cryptocurrency') ?></label>
        ...
        <div class="form-group">
            <label for="payment_blocks_fee"><i class="fas fa-fw fa-sm fa-coins text-muted mr-1"></i> <?= l('admin_settings.plisio_whitelabel.payment_blocks_fee') ?></label>
