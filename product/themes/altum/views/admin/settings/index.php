    ...
    <div class="mb-3 mb-xl-0 col-12 col-xl-4 order-xl-1">
        <div class="d-xl-none">
            <select class="custom-select" onchange="if(this.value) window.location.href=this.value">
                ...
                <option value="<?= url('admin/settings/security') ?>" class="nav-link" <?= $data->method == 'security' ? 'selected="selected"' : null ?>>🔒 <?= l('admin_settings.security.tab') ?></option>
        ...
        <div class="card d-none d-xl-flex">
            <div class="card-body">
                <div class="nav flex-column nav-pills" role="tablist" aria-orientation="vertical">
                    ...
                    <a class="nav-link <?= $data->method == 'security' ? 'active' : null ?>" href="<?= url('admin/settings/security') ?>"><i class="fas fa-fw fa-sm fa-shield-alt mr-2"></i> <?= l('admin_settings.security.tab') ?></a>
