...
<div class="card">
    <div class="card-body">
        ...
        <form id="update_event" name="update_event" action="" method="post" role="form">
            ...
            <?php if(settings()->links->pixels_is_enabled): ?>
                ...
                <div class="collapse" data-parent="#update_event" id="pixels_container">
                    <div class="form-group">
            ...
            <div class="collapse" data-parent="#update_event" id="temporary_url_container">
            ...
            <div class="collapse" data-parent="#update_event" id="protection_container">
            ...
            <div class="collapse" data-parent="#update_event" id="seo_container">
            ...
            <div class="collapse" data-parent="#update_event" id="advanced_container">
