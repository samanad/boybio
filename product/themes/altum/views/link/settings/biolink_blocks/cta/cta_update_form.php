...
<form name="update_biolink_" method="post" role="form" data-type="<?= $row->type ?>">
    ...
    <div class="form-group">
        <label for="<?= 'cta_type_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-comments fa-sm text-muted mr-1"></i> <?= l('global.type') ?></label>
        <select id="<?= 'cta_type_' . $row->biolink_block_id ?>" name="type" class="custom-select">
            <option value="email" <?= $row->settings->type == 'email' ? 'selected="selected"' : null ?>><?= l('biolink_cta.type_email') ?></option>
            <option value="call" <?= $row->settings->type == 'call' ? 'selected="selected"' : null ?>><?= l('biolink_cta.type_call') ?></option>
            <option value="sms" <?= $row->settings->type == 'sms' ? 'selected="selected"' : null ?>><?= l('biolink_cta.type_sms') ?></option>
            <option value="facetime" <?= $row->settings->type == 'facetime' ? 'selected="selected"' : null ?>><?= l('biolink_cta.type_facetime') ?></option>
        </select>
    </div>
    ...
    <div class="form-group">
        <label for="<?= 'cta_name_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-signature fa-sm text-muted mr-1"></i> <?= l('biolink_link.name') ?></label>
    ...
    <div class="form-group" data-file-image-input-wrapper data-file-input-wrapper-size-limit="<?= settings()->links->thumbnail_image_size_limit ?>" data-file-input-wrapper-size-limit-error="<?= sprintf(l('global.error_message.file_size_limit'), settings()->links->thumbnail_image_size_limit) ?>">
        <label for="<?= 'cta_image_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-image fa-sm text-muted mr-1"></i> <?= l('biolink_link.image') ?></label>
    ...
    <div class="form-group">
        <label for="<?= 'cta_text_color_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-paint-brush fa-sm text-muted mr-1"></i> <?= l('biolink_link.text_color') ?></label>
    ...
    <div class="form-group">
        <label for="<?= 'cta_background_color_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-fill fa-sm text-muted mr-1"></i> <?= l('biolink_link.background_color') ?></label>
    ...
    <div class="form-group">
        <label for="<?= 'cta_animation_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-film fa-sm text-muted mr-1"></i> <?= l('biolink_link.animation') ?></label>
    ...
    <div class="form-group" data-animation="<?= implode(',', require APP_PATH . 'includes/biolink_animations.php') ?>">
        <label for="<?= 'cta_animation_runs_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-play-circle fa-sm text-muted mr-1"></i> <?= l('biolink_link.animation_runs') ?></label>
