    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h5 class="modal-title"><?= l('biolink_big_link.header') ?></h5>
            ...
            <div class="modal-body">
                <form name="create_biolink_big_link" method="post" role="form">
                    ...
                    <div class="form-group">
                        <label for="big_link_location_url"><i class="fas fa-fw fa-link fa-sm text-muted mr-1"></i> <?= l('biolink_link.location_url') ?></label>
                    ...
                    <div class="form-group">
                        <label for="big_link_name"><i class="fas fa-fw fa-signature fa-sm text-muted mr-1"></i> <?= l('biolink_link.name') ?></label>
                        <input id="big_link_name" type="text" name="name" maxlength="128" class="form-control" required="required" />
                    </div>

                    <div class="form-group">
                        <label for="big_link_description"><i class="fas fa-fw fa-paragraph fa-sm text-muted mr-1"></i> <?= l('biolink_link.description') ?></label>
