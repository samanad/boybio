...
<form name="update_biolink_" method="post" role="form" data-type="<?= $row->type ?>">
    ...
    <button class="btn btn-block btn-gray-300 my-4" type="button" data-toggle="collapse" data-target="#<?= 'email_collector_settings_container_' . $row->biolink_block_id ?>" aria-expanded="false" aria-controls="<?= 'email_collector_settings_container_' . $row->biolink_block_id ?>">
        <i class="fas fa-fw fa-wrench fa-sm mr-1"></i> <?= l('biolink_email_collector.email_collector_header') ?>
    </button>

    <div class="collapse" id="<?= 'email_collector_settings_container_' . $row->biolink_block_id ?>">
        <div class="form-group">
            <label for="<?= 'email_collector_email_placeholder_' . $row->biolink_block_id ?>"><?= l('biolink_email_collector.email_placeholder') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'email_collector_name_placeholder_' . $row->biolink_block_id ?>"><?= l('biolink_email_collector.name_placeholder') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'email_collector_button_text_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-square fa-sm text-muted mr-1"></i> <?= l('biolink_link.button_text') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'email_collector_success_text_' . $row->biolink_block_id ?>"><?= l('biolink_email_collector.success_text') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'email_collector_thank_you_url_' . $row->biolink_block_id ?>"><?= l('biolink_email_collector.thank_you_url') ?></label>
        ...
        <div class="form-group custom-control custom-switch">
            ...
            >
            <label class="custom-control-label" for="<?= 'email_collector_show_agreement_' . $row->biolink_block_id ?>"><?= l('biolink_email_collector.show_agreement') ?></label>
            <div><small class="form-text text-muted"><?= l('biolink_email_collector.show_agreement_help') ?></small></div>
        </div>

        <div class="form-group">
            <label for="<?= 'email_collector_agreement_text_' . $row->biolink_block_id ?>"><?= l('biolink_email_collector.agreement_text') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'email_collector_agreement_url_' . $row->biolink_block_id ?>"><?= l('biolink_email_collector.agreement_url') ?></label>
    ...
    <div class="collapse" id="<?= 'button_settings_container_' . $row->biolink_block_id ?>">
        <div class="form-group">
            <label for="<?= 'email_collector_name_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-signature fa-sm text-muted mr-1"></i> <?= l('biolink_link.name') ?></label>
        ...
        <div class="form-group" data-file-image-input-wrapper data-file-input-wrapper-size-limit="<?= settings()->links->thumbnail_image_size_limit ?>" data-file-input-wrapper-size-limit-error="<?= sprintf(l('global.error_message.file_size_limit'), settings()->links->thumbnail_image_size_limit) ?>">
            <label for="<?= 'email_collector_image_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-image fa-sm text-muted mr-1"></i> <?= l('biolink_link.image') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'email_collector_text_color_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-paint-brush fa-sm text-muted mr-1"></i> <?= l('biolink_link.text_color') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'email_collector_background_color_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-fill fa-sm text-muted mr-1"></i> <?= l('biolink_link.background_color') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'email_collector_animation_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-film fa-sm text-muted mr-1"></i> <?= l('biolink_link.animation') ?></label>
        ...
        <div class="form-group" data-animation="<?= implode(',', require APP_PATH . 'includes/biolink_animations.php') ?>">
            <label for="<?= 'email_collector_animation_runs_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-play-circle fa-sm text-muted mr-1"></i> <?= l('biolink_link.animation_runs') ?></label>
