...
<form name="update_biolink_" method="post" role="form" data-type="<?= $row->type ?>">
    ...
    <button class="btn btn-block btn-gray-300 my-4" type="button" data-toggle="collapse" data-target="#<?= 'donation_settings_container_' . $row->biolink_block_id ?>" aria-expanded="false" aria-controls="<?= 'donation_settings_container_' . $row->biolink_block_id ?>">
        <i class="fas fa-fw fa-hand-holding-dollar fa-sm mr-1"></i> <?= l('biolink_donation.donation_header') ?>
    </button>

    <div class="collapse" id="<?= 'donation_settings_container_' . $row->biolink_block_id ?>">
        <div class="form-group">
            <label for="<?= 'donation_title_' . $row->biolink_block_id ?>"><?= l('biolink_donation.title') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'donation_description_' . $row->biolink_block_id ?>"><?= l('biolink_donation.description') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'donation_prefilled_amount_' . $row->biolink_block_id ?>"><?= l('biolink_donation.prefilled_amount') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'donation_minimum_amount_' . $row->biolink_block_id ?>"><?= l('biolink_donation.minimum_amount') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'donation_currency_' . $row->biolink_block_id ?>"><?= l('biolink_donation.currency') ?></label>
            ...
            <small class="form-text text-muted"><?= l('biolink_donation.currency_help') ?></small>
        </div>
        ...
        <div class="form-group custom-control custom-switch">
            ...
            <label class="custom-control-label" for="<?= 'donation_allow_custom_amount_' . $row->biolink_block_id ?>"><?= l('biolink_donation.allow_custom_amount') ?></label>
        </div>
        ...
        <div class="form-group custom-control custom-switch">
            ...
            <label class="custom-control-label" for="<?= 'donation_allow_message_' . $row->biolink_block_id ?>"><?= l('biolink_donation.allow_message') ?></label>
            <small class="form-text text-muted"><?= l('biolink_donation.allow_message_help') ?></small>
        </div>

        <div class="form-group">
            <label for="<?= 'donation_thank_you_title_' . $row->biolink_block_id ?>"><?= l('biolink_donation.thank_you_title') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'donation_thank_you_description_' . $row->biolink_block_id ?>"><?= l('biolink_donation.thank_you_description') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'donation_thank_you_url_' . $row->biolink_block_id ?>"><?= l('biolink_donation.thank_you_url') ?></label>
    ...
    <div class="collapse" id="<?= 'button_settings_container_' . $row->biolink_block_id ?>">
        <div class="form-group">
            <label for="<?= 'donation_name_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-signature fa-sm text-muted mr-1"></i> <?= l('biolink_link.name') ?></label>
        ...
        <div class="form-group" data-file-image-input-wrapper data-file-input-wrapper-size-limit="<?= settings()->links->thumbnail_image_size_limit ?>" data-file-input-wrapper-size-limit-error="<?= sprintf(l('global.error_message.file_size_limit'), settings()->links->thumbnail_image_size_limit) ?>">
            <label for="<?= 'donation_image_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-image fa-sm text-muted mr-1"></i> <?= l('biolink_link.image') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'donation_text_color_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-paint-brush fa-sm text-muted mr-1"></i> <?= l('biolink_link.text_color') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'donation_background_color_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-fill fa-sm text-muted mr-1"></i> <?= l('biolink_link.background_color') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'donation_animation_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-film fa-sm text-muted mr-1"></i> <?= l('biolink_link.animation') ?></label>
        ...
        <div class="form-group" data-animation="<?= implode(',', require APP_PATH . 'includes/biolink_animations.php') ?>">
            <label for="<?= 'donation_animation_runs_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-play-circle fa-sm text-muted mr-1"></i> <?= l('biolink_link.animation_runs') ?></label>
